	...
	<div class="col-xs-12">
				...
				<div class="widget-box widget-color-blue">
					<div class="widget-header ">
						<h5 class="widget-title bigger lighter ">
							...
							<span class="hidden-sm hidden-xs">Data Grup Pengguna</span>
							<span class="hidden-md hidden-lg">Grup Pengguna</span>
						</h5>
		...
		<div class="table-container">
			...
			<tr role="row" class="filter">
				...
				<td>
					<input type="text" class="form-control form-filter input-sm" name="order_namaGroup">
				</td>
				<td>
					<input type="text" class="form-control form-filter input-sm" name="order_deskGroup">
				</td>
				<td>
