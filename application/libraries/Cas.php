...
function cas_show_config_error(){
	...
	<ul>
	   ...
	   <li><em>cas_phplib_path</em>: path to a installation of
	...
	public function __construct(){
		...
		*/
		...
		if ($CI->config->item('cas_disable_server_validation')){
			...
			$ca_cert_file = $CI->config->item('cas_ca_cert_file');
